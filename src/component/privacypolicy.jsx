        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <Typography paragraph>
                    <Typography variant='h6' mb={1} style={{fontWeight: 700}}>What is privacy policy?</Typography>
                ...
                <Typography paragraph>
                <Typography variant='h6' mb={1} style={{fontWeight: 700}}>how is work?</Typography>
