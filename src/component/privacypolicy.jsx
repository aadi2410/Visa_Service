    ...
    const drawer = (
        <div>
            ...
            <List style={{ padding: 0 }}>
                    ...
                    <ListItem disablePadding>
                        <Link to='/privacypolicy' className="sidebar_item active">
                            <SwipeRightAltIcon />
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <Typography paragraph>
                    <Typography variant='h5' mb={1} style={{fontWeight: 700}}>What is privacy policy?</Typography>
                ...
                <Typography paragraph>
                <Typography variant='h5' mb={1} style={{fontWeight: 700}}>how is work?</Typography>
